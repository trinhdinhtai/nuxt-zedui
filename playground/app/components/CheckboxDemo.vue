...
<template>
  <div class="flex flex-col gap-6 max-w-2xl">
    <div class="flex items-center gap-3">
      <ZCheckbox id="terms" />
      <ZLabel for="terms">Accept terms and conditions</ZLabel>
    </div>
    <div class="flex items-start gap-3">
      <ZCheckbox id="terms-2" :default-value="true" />
      <div class="grid gap-2">
        <ZLabel for="terms-2">Accept terms and conditions</ZLabel>
    ...
    <div class="flex items-start gap-3">
      <ZCheckbox id="toggle" disabled />
      <ZLabel for="toggle">Enable notifications</ZLabel>
    </div>
    <ZLabel
